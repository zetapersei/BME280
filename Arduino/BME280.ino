...
unsigned short dig_P1 = (b1[6] & 0xff) + ((b1[7] & 0xff ) * 256);
...
short dig_H2 = b1[0] + (b1[1] * 256);
unsigned short dig_H3 = b1[2] & 0xFF ;
short dig_H4 = (b1[3] * 16) + (b1[4] & 0xF);
short dig_H5 = (b1[4] / 16) + (b1[5] * 16);
short dig_H6 = b1[6];
